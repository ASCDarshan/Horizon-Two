...
!(function (e, t) {
  ...
  function E(t) {
    return function (e) {
      return (
        e || 0 === e
          ? (r && (ve.history.scrollRestoration = "manual"),
            t(e),
            (t.v = e),
            (t.c = ze.cache),
            Pe && Pe.isPressed && Re("ss", e))
          : (ze.cache === t.c && !Re("ref")) || ((t.c = ze.cache), (t.v = t())),
        t.v
      );
    };
  }
  function H(e) {
    return (
      he.utils.toArray(e)[0] ||
      ("string" == typeof e && !1 !== he.config().nullTargetWarn
  ...
  function M(e) {
    return (
      (he = e || p()) &&
        ...
        document.body &&
        ((ve = window),
        (Se = (me = document).documentElement),
        (_e = me.body),
        (t = [ve, me, Se, _e]),
        he.utils.clamp,
        (ke = "onpointerenter" in _e ? "pointer" : "mouse"),
        (Te = w.isTouch =
          ve.matchMedia &&
    ...
    Le = {
      ...
      sc: E(function (e) {
        return arguments.length
          ? ve.scrollTo(e, Xe.sc())
          : ve.pageXOffset || me[n] || Se[n] || _e[n] || 0;
      }),
    },
    Xe = {
      s: i,
      ...
      sc: E(function (e) {
        return arguments.length
          ? ve.scrollTo(Le.sc(), e)
          : ve.pageYOffset || me[i] || Se[i] || _e[i] || 0;
      }),
    };
  (Le.op = Xe), (ze.cache = 0);
  var w =
    ((Observer.prototype.init = function init(e) {
      be || M(he) || console.warn("Please gsap.registerPlugin(Observer)"),
        Me ||
          ((Me = he.core.globals().ScrollTrigger) &&
            Me.core &&
            (function _integrate() {
              var e = Me.core,
                r = e.bridge || {},
      ...
      function ue(e, t) {
        return (
          ((ee.event = e) && u && ~u.indexOf(e.target)) ||
      ...
      function we() {
        var e = (ee.deltaX = L(de)),
          ...
          r = Math.abs(e) >= i,
          n = Math.abs(t) >= i;
        k && (r || n) && k(ee, e, t, de, pe),
          r &&
            (m && 0 < ee.deltaX && m(ee),
            x && ee.deltaX < 0 && x(ee),
            _ && _(ee),
            E && ee.deltaX < 0 != te < 0 && E(ee),
            (te = ee.deltaX),
            (de[0] = de[1] = de[2] = 0)),
          n &&
            (S && 0 < ee.deltaY && S(ee),
      ...
      function xe(e, t, r) {
        (de[r] += e),
          ...
          ee._vx.update(e, 2 === r),
          ee._vy.update(t, 2 === r),
          o ? (q = q || requestAnimationFrame(we)) : we();
      }
      function ye(e) {
        if (!ue(e, 1)) {
          ...
          (ee.x = t),
            (ee.y = r),
            (o ||
              Math.abs(ee.startX - t) >= a ||
              Math.abs(ee.startY - r) >= a) &&
              (h && (Z = !0),
              o || (ee.isDragging = !0),
              xe(n, i, 2),
              o || (p && p(ee)));
      ...
      function Ee(e) {
        if (!ue(e)) {
          (e = K(e, s)), j && (Q = !0);
          var t =
            (1 === e.deltaMode ? n : 2 === e.deltaMode ? ve.innerHeight : 1) *
            f;
      ...
      (this.target = r = H(r) || Se),
        ...
        (o = !1 !== o),
        (n = n || parseFloat(ve.getComputedStyle(_e).lineHeight) || 22);
      var q,
        U,
        Z,
        $,
        ...
        se = (
          "ontouchstart" in Se
            ...
            : 0 <= t.indexOf("pointer") && !("onpointerdown" in Se)
      ...
      (U = ee._dc =
        ...
        (ee.enable = function (e) {
          return (
            ee.isEnabled ||
              (z(ce ? fe : r, "scroll", D),
              0 <= t.indexOf("scroll") && z(ce ? fe : r, "scroll", De, s),
              0 <= t.indexOf("wheel") && z(r, "wheel", Ee, s),
              ((0 <= t.indexOf("touch") && Te) || 0 <= t.indexOf("pointer")) &&
                (z(r, se[0], ge, s),
                z(fe, se[2], Ae),
                z(fe, se[3], Ae),
                N && z(r, "click", Ie),
                B && z(fe, "gesturestart", Be),
                X && z(fe, "gestureend", Ce),
                P && z(r, ke + "enter", Ge),
                O && z(r, ke + "leave", He),
                F && z(r, ke + "move", Fe)),
              (ee.isEnabled = !0),
  ...
  function Ca(e, t) {
    ...
    return (r = "scroll" + n) && (o = x(e, r))
      ...
      : ya(e)
      ? (Ke[r] || We[r]) -
        (Ve["inner" + n] || Ke["client" + n] || We["client" + n])
      : e[r] - e["offset" + n];
  }
  function Da(e, t) {
  ...
  function yb() {
    ze.cache++,
      Ze ||
        ...
        (v &&
          S === Ve.innerWidth &&
          !(Math.abs(Ve.innerHeight - m) > 0.25 * Ve.innerHeight)) ||
        s.restart(!0);
  }
  function Eb(e) {
    var t,
      ...
      i = 0;
    if (T !== r || at) {
      for (N(); i < X.length; i += 4)
        (t = Ve.matchMedia(X[i]).matches) !== X[i + 3] &&
          ((X[i + 3] = t)
            ? n.push(i)
            : N(1, X[i]) || (Fa(X[i + 2]) && X[i + 2]()));
      for (G(), i = 0; i < n.length; i++)
        (t = n[i]), (nt = X[t]), (X[t + 2] = X[t + 1](e));
    ...
    if (o) {
      ...
      (p = "scroll" + n.d2),
        Y(
          ...
          n,
          (_ && 20 < S) ||
            (!_ && (u ? Math.max(We[p], Ke[p]) : o.parentNode[p]) <= S + 1)
        ),
        u &&
          ((l = wt(a)),
  ...
  var je,
    ...
    N = function _revertAll(e, t) {
      ...
      for (Qe = 0; Qe < Tt.length; Qe++)
        (r = Tt[Qe]), (t && r.media !== t) || (e ? r.kill(1) : r.revert());
      t && G(t), t || j("revert");
    },
    W = 0,
    ...
    Z = function _updateAll() {
      if (!it) {
        ...
        if (
          ...
          (U = n),
          r &&
            (lt && !$e && 200 < t - lt && ((lt = 0), j("scrollEnd")),
            (Ue = k),
            (k = t)),
          Et < 0)
        ) {
    ...
    re =
      ((ScrollTrigger.prototype.init = function init(_, T) {
        if (
          ((this.progress = this.start = 0), this.vars && this.kill(!0, !0), ct)
        ) {
          var v,
            n,
            f,
            ...
            Z,
            o,
            $ = (_ = cb(Ea(_) || Ga(_) || _.nodeType ? { trigger: _ } : _, _t))
              .onUpdate,
            Q = _.toggleClass,
            a = _.id,
            ee = _.onToggle,
          ...
          if (
            ...
            "refreshPriority" in _ &&
              ((et = 1), -9999 === _.refreshPriority && (ot = Se)),
            ...
            ce &&
              ...
              "scrollBehavior" in We.style &&
                je.set(ve ? [We, Ke] : be, { scrollBehavior: "auto" }),
              (f = Fa(ce.snapTo)
                ? ce.snapTo
                : "labels" === ce.snapTo
                ...
                : je.utils.snap(ce.snapTo)),
              (d = ce.duration || { min: 0.1, max: 2 }),
              (d = Ha(d) ? Je(d.min, d.max) : Je(d, d)),
              (W = je
                .delayedCall(ce.delay || i / 2 || 0.1, function () {
            ...
            ie &&
              (!1 === oe ||
                oe === mt ||
                (oe = !(!oe && "flex" === ab(ie.parentNode).display) && vt),
              (Se.pin = ie),
              !1 !== _.force3D && je.set(ie, { force3D: !0 }),
              ...
              (y = r[oe + ge.os2]),
              (B = je.getProperty(ie)),
              (m = je.quickSetter(ie, ge.a, xt)),
              Vb(ie, L, r),
              (R = Yb(ie))),
            u)
          ) {
            (e = Ha(u) ? cb(u, St) : St),
              (A = rb("scroller-start", a, be, ge, e, 0)),
              (D = rb("scroller-end", a, be, ge, e, 0, A)),
              (t = A["offset" + ge.op.d2]);
            var h = H(x(be, "content") || be);
            (P = this.markerStart = rb("start", a, h, ge, e, t, 0, fe)),
              (O = this.markerEnd = rb("end", a, h, ge, e, t, 0, fe)),
              fe && (Z = je.quickSetter([P, O], ge.a, xt)),
              me ||
                ...
                je.set([A, D], { force3D: !0 }),
                (w = je.quickSetter(A, ge.a, xt)),
                (S = je.quickSetter(D, ge.a, xt)));
          }
          if (fe) {
          ...
          (Se.previous = function () {
            ...
            (Se.revert = function (e) {
              ...
              t !== Se.isReverted &&
                (t &&
                  (!Se.scroll.rec && Ze && it && (Se.scroll.rec = Ee()),
                  (J = Math.max(Ee(), Se.scroll.rec || 0)),
                  (q = Se.progress),
                  (U = T && T.progress())),
                P &&
                  [P, O, A, D].forEach(function (e) {
                ...
                ie &&
                  (t
                    ...
                    : (ue && Se.isActive) || Vb(ie, L, ab(ie), V)),
                (Se.isReverted = t));
            }),
                ...
                if (ie && e && lt) kb(ScrollTrigger, "scrollEnd", Fb);
                  ...
                  for (
                    var r,
                      ...
                      w = (ne && Math.max(0, Tt.indexOf(Se))) || 0,
                      S = w;
                    S--;

                  )
                    (s = Tt[S]).end || s.refresh(0, 1) || (Ze = 1),
                      !(l = s.pin) ||
                        (l !== ne && l !== ie) ||
                        s.isReverted ||
                  ...
                  for (
                    Fa(y) && (y = y(Se)),
                      C =
                        _b(y, ne, d, ge, Ee(), P, A, Se, p, we, me, g, fe) ||
                        (ie ? -0.001 : 0),
                      Fa(v) && (v = v(Se)),
                      Ea(v) &&
                        !v.indexOf("+=") &&
                  ...
                  if (
                    ...
                    (r = ab(ie)),
                      (o = ge === Xe),
                      (i = Ee()),
                      (X = parseFloat(B(ge.a)) + b),
                      !g &&
                        1 < M &&
                        ((ve ? We : be).style["overflow-" + ge.a] = "scroll"),
                      Vb(ie, L, r),
                      (R = Yb(ie)),
                      (n = wt(ie, !0)),
                      (c = me && I(be, o ? Le : Xe)()),
                      oe &&
                        (((V = [oe + ge.os2, z + b + xt]).t = L),
                        (S = oe === vt ? eb(ie, ge) + z + b : 0) &&
                          V.push(ge.d, S + xt),
                        Ct(V),
                        me && Ee(J)),
                      me &&
                        (((a = {
                          ...
                          Math.ceil(n.width) + xt),
                        (a[dt] = a.maxHeight = Math.ceil(n.height) + xt),
                        (a[mt] =
                          a[mt + ht] =
                          a[mt + pt] =
                          a[mt + bt] =
                      ...
                      T
                        ? ((u = T._initted),
                          ...
                          (j = B(ge.a) - X + z + b),
                          z !== j && Y.splice(Y.length - 2, 2),
                          T.render(0, !0, !0),
                          u || T.invalidate(),
                          tt(0))
                        : (j = z);
                  else if (ne && Ee() && !fe)
                    for (n = ne.parentNode; n && n !== We; )
                      n._pinOffset &&
            ...
            (Se.getTrailing = function (t) {
              var e = Tt.indexOf(Se),
                r =
                  0 < Se.direction ? Tt.slice(0, e).reverse() : Tt.slice(e + 1);
              return (
                Ea(t)
                  ? r.filter(function (e) {
              ...
              if (!fe || r || e) {
                ...
                if (
                  (t &&
                    ((E = k),
                    (k = fe ? Ee() : u),
                    ce && ((N = G), (G = T && !he ? T.totalProgress() : d))),
                  se &&
                    !d &&
                    ie &&
                    !Ze &&
                  ...
                  !ce || v.tween || Ze || at || W.restart(!0),
                    Q &&
                      (s || (le && d && (d < 1 || !rt))) &&
                      qe(Q.targets).forEach(function (e) {
      ...
      (ScrollTrigger.disable = function disable(t, r) {
        ...
        for (var e = 0; e < ze.length; e += 3)
          mb(lb, ze[e], ze[e + 1]), mb(lb, ze[e], ze[e + 2]);
      }),
      (ScrollTrigger.enable = function enable() {
        if (
          ((Ve = window),
          (Ne = document),
          (Ke = Ne.documentElement),
          (We = Ne.body),
          je &&
            ((qe = je.utils.toArray),
            (Je = je.utils.clamp),
            (tt = je.core.suppressOverwrites || ua),
          ...
          for (
            r.borderTopStyle = "solid",
              ...
              c = je.utils.checkPrefix("transform"),
              Q.push(c),
              o = st(),
              s = je.delayedCall(0.2, q).pause(),
              g = [
                Ne,
                "visibilitychange",
                function () {
            ...
            mb(lb, ze[t], ze[t + 1]), mb(lb, ze[t], ze[t + 2]);
        }
      }),
      ...
      (ScrollTrigger.scrollerProxy = function scrollerProxy(e, t) {
        var r = H(e),
          ...
          i = ya(r);
        ~n && ze.splice(n, i ? 6 : 2),
          t && (i ? Ye.unshift(Ve, t, We, t, Ke, t) : Ye.unshift(r, t));
      }),
          ...
          (n = X.indexOf(r)),
            ...
            "all" === (nt = r)
              ...
              : (t = Ve.matchMedia(r)) &&
                (t.matches && (o = i()),
                ~n
                  ? ((X[n + 1] = Ja(X[n + 1], i)), (X[n + 2] = Ja(X[n + 2], o)))
                  : ((n = X.length),
                    X.push(r, i, o),
                    t.addListener
                      ? t.addListener(Eb)
      ...
      (ScrollTrigger.isInViewport = function isInViewport(e, t, r) {
        var n = (Ea(e) ? H(e) : e).getBoundingClientRect(),
          i = n[r ? ft : dt] * t || 0;
        return r
          ? 0 < n.right - i && n.left + i < Ve.innerWidth
          : 0 < n.bottom - i && n.top + i < Ve.innerHeight;
      }),
  ...
  function fc(e) {
    !0 === e
      ? (We.style.removeProperty("touch-action"),
        Ke.style.removeProperty("touch-action"))
      : (We.style.touchAction = Ke.style.touchAction = e ? "pan-" + e : "none");
  }
  function gc(e) {
    function po() {
      return (d = st());
    ...
    function Bo() {
      to(),
        s.isActive() && s.vars.scrollY > r && s.resetTo("scrollY", Ca(Ke, Xe));
    }
    Ha(e) || (e = {}),
    ...
    return (
      ...
      (e.onPress = function () {
        var e = h;
        (h = (Ve.visualViewport && Ve.visualViewport.scale) || 1),
          s.pause(),
          e !== h && fc(1 < h || (!f && "x")),
          (n = !1),
          (a = g()),
      ...
      (e.onEnable = function (e) {
        fc(!f && "x"),
          kb(Ve, "resize", Bo),
          e.target.addEventListener("click", po, { capture: !0 });
      }),
